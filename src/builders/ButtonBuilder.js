...
module.exports = class ButtonBuilder {
    ...
    setCustomID(id) {
        if ('style' in this.#json && this.#json.style !== ButtonStyles.LINK) {
            this.#json.customID = id;
        } else {
            throw new Error("URL type buttons do not support customIDs");
        }
        return this;
    }
 ...
 */
    ...
    setURL(url) {
        if (this.#json.type === ComponentTypes.BUTTON && this.#json.style === ButtonStyles.LINK) {
            ...
            throw new Error("setURL can only be used with URL buttons");
        }
        return this;
    }
